        ...
        for record in df.to_dict("records"):
            ...
            daily_data.append(KLineDataPoint(
                **base_point,
                ...
                free_share=_normalize_numeric(record.get("free_share")),
                circ_mv=_normalize_numeric(record.get("circ_mv")),
                buy_sm_amount=_normalize_numeric(record.get("buy_sm_amount")),
                sell_sm_amount=_normalize_numeric(record.get("sell_sm_amount")),
                buy_md_amount=_normalize_numeric(record.get("buy_md_amount")),
                sell_md_amount=_normalize_numeric(record.get("sell_md_amount")),
                buy_lg_amount=_normalize_numeric(record.get("buy_lg_amount")),
                sell_lg_amount=_normalize_numeric(record.get("sell_lg_amount")),
